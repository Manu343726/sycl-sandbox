...
inline float3 quad_corner(Axis primary_axis, float axis_value,
...
inline void add_box(Object* objects, int& object_count,
                    ...
                    Material material) {
    add_quad(objects, object_count, Axis::Y, corner_y + size_y, corner_x, corner_x + size_x, corner_z, corner_z + size_z, material);
    add_quad(objects, object_count, Axis::Y, corner_y,           corner_x, corner_x + size_x, corner_z, corner_z + size_z, material);
    add_quad(objects, object_count, Axis::Z, corner_z,           corner_x, corner_x + size_x, corner_y, corner_y + size_y, material);
    add_quad(objects, object_count, Axis::Z, corner_z + size_z,  corner_x, corner_x + size_x, corner_y, corner_y + size_y, material);
    add_quad(objects, object_count, Axis::X, corner_x,           corner_z, corner_z + size_z, corner_y, corner_y + size_y, material);
    add_quad(objects, object_count, Axis::X, corner_x + size_x,  corner_z, corner_z + size_z, corner_y, corner_y + size_y, material);
}
